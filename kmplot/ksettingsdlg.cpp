/***************************************************************************
  kmplot/ksettingsdlg.cpp  -  manipulating global KmPlot defaults
                       -------------------
begin                : 2002-06-23
        ...
        : QWidget( parent, name )
{
    ...
    QToolTip::add( le_td, i18n( "Tic mark line thickness" ) );
    ...
    QToolTip::add( le_tl, i18n( "Tic mark line length" ) );
    ...
    QToolTip::add( le_ad, i18n( "Thickness of the Axes line" ) );
